...
namespace Dmon777\StringModifier;
...
class StrMod
{
     ...
     * @return string
     */
    public static function UP(string $str)
    {
     ...
     * @return string
     */
    public static function LOW(string $str)
    {
     ...
     * @return string
     */
    public static function TRANSLITERATOR(string $str)
    {
